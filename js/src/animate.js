...
define(['jquery'], function($) {
	...
	return {
		animate: function() {
			...
			// hello
			window.addEventListener('impress:stepenter', function() {
				$('#hello.active #typing1').addClass('step19');
			});
			window.addEventListener('impress:stepenter', function() {
				$('#hello.past #typing1').removeClass('step19');
			});
			window.addEventListener('impress:stepenter', function() {
				$('#hello.active #typing2').addClass('step22');
			});
			window.addEventListener('impress:stepenter', function() {
				$('#hello.past #typing2').removeClass('step22');
			});
			window.addEventListener('impress:stepenter', function() {
				$('#hello.active #typing3').addClass('step17');
			});
			window.addEventListener('impress:stepenter', function() {
				$('#hello.past #typing3').removeClass('step17');
			});
